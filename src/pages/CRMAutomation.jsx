...
function ReviewsSummary() {
  ...
  const displayed = (filterStar ? reviews.filter((r) => r.rating === filterStar) : reviews).slice(
    0,
    showAll ? 999 : 5
  );
  ...
  return (
    <div>
      ...
      {showForm && (
        <div
          className="mb-5 rounded-2xl border p-5 space-y-3"
        ...
        >
                ...
                {[1, 2, 3, 4, 5].map((n) => (
                  <button
                    ...
                    className={`text-2xl transition-transform hover:scale-110 ${
                      n <= form.rating ? "text-yellow-400" : "text-gray-700"
                    }`}
                  >
                    ★
                  </button>
          ...
          <div className="flex gap-2 justify-end">
            <button
              ...
              className="text-xs px-4 py-2 rounded-xl text-gray-400 hover:text-white border border-white/10 hover:bg-white/5 transition-all"
            >
              Batal
            </button>
            <button
      ...
      <div
        className="rounded-2xl border p-5 grid grid-cols-1 sm:grid-cols-2 gap-6 mb-5"
      ...
      >
            ...
            {[5, 4, 3].map((n) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-xl py-2 transition-all border text-xs ${
                    filterStar === n
        ...
        <div className="space-y-2.5">
          {dist.map(({ star, count }) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-2 group transition-all rounded-lg px-1 py-0.5 ${
                  filterStar === star ? "bg-yellow-500/10" : "hover:bg-white/3"
                }`}
              >
          ...
          <div className="pt-2 border-t border-white/5 text-xs text-gray-600">
            ...
            {filterStar > 0 && (
              <button onClick={() => setFilterStar(0)} className="text-gray-500 hover:text-white underline">
                Reset
              </button>
            )}
          </div>
            ...
            >
              <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center justify-between gap-2 mb-0.5">
                      ...
                      <div className="flex gap-0.5 flex-shrink-0">
                        {[1, 2, 3, 4, 5].map((s) => (
                          <span
                            key={s}
                            className={`text-sm ${s <= r.rating ? "text-yellow-400" : "text-gray-700"}`}
                          >
                            ★
                          </span>
                        ))}
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 text-gray-700 hover:text-red-400 transition-all flex-shrink-0 text-xs p-1"
                >
                  ✕
                </button>
              </div>
