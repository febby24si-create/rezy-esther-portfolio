          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 rounded-xl bg-black/40 border transition-all duration-300 focus:outline-none text-white ${
                focused === 'name' ? 'border-blue-500/50 shadow-lg glow-brand scale-[1.02]' : 'border-white/10'
              }`}
        ...
        <div className="transform transition-all duration-300 hover:scale-[1.01]">
          ...
          <div className="relative">
            ...
            <input
              ...
              onBlur={() => setFocused(null)}
              className={`w-full pl-10 pr-4 py-3 rounded-xl bg-black/40 border transition-all duration-300 focus:outline-none text-white ${
                focused === 'email' ? 'border-blue-500/50 shadow-lg glow-brand scale-[1.02]' : 'border-white/10'
              }`}
        ...
        <div className="transform transition-all duration-300 hover:scale-[1.01]">
          ...
          <div className="relative">
            ...
            <input
              ...
              onBlur={() => setFocused(null)}
              className={`w-full pl-10 pr-4 py-3 rounded-xl bg-black/40 border transition-all duration-300 focus:outline-none text-white ${
                focused === 'phone' ? 'border-blue-500/50 shadow-lg glow-brand scale-[1.02]' : 'border-white/10'
              }`}
          ...
          <div className="relative">
            ...
            <textarea
              ...
              className={`w-full pl-10 pr-4 py-3 rounded-xl bg-black/40 border transition-all duration-300 focus:outline-none text-white resize-none ${
                focused === 'message' ? 'border-blue-500/50 shadow-lg glow-brand scale-[1.02]' : 'border-white/10'
              }`}
...
export default function LandingPage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      publicAPI.fetchStats()
    ]).then(([testimonialsData, statsData]) => {
  ...
  return (
    <div className="overflow-x-hidden bg-garage-950 text-slate-50 font-body relative">
      {/* ─── PARTICLES ─── */}
      <ParticleBackground />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <Reveal direction="left" distance={30}>
              <div className="relative rounded-2xl overflow-hidden shadow-2xl glow-brand group">
                <img
                  src={IMAGES.about}
            ...
            <Reveal delay={150} direction="right" distance={30}>
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-brand text-xs font-semibold tracking-widest uppercase">Tentang Kami</span>
              </div>
              ...
              <div ref={statsRef} className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  { target: stats.pelanggan, suffix: '+', label: 'Pelanggan', color: 'from-blue-400 to-blue-600' },
                  { target: stats.mekanik, suffix: '+', label: 'Mekanik', color: 'from-orange-400 to-orange-600' },
                  { target: stats.tahun, suffix: '+', label: 'Tahun', color: 'from-white to-white' },
                  { target: stats.kepuasan, suffix: '%', label: 'Kepuasan', color: 'from-emerald-400 to-emerald-600' },
                ].map((stat, idx) => (
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-4 text-xs">
                <div className="flex-1 glass-card rounded-xl p-4 transform transition-all duration-300 hover:scale-105 hover:border-brand">
                  <span className="text-brand font-bold block mb-1">Visi</span>
      ...
      {/* ─── TIMELINE ─── */}
      <section id="timeline" className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-900 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(37,99,235,0.04),transparent_70%)]" />
        <div className="max-w-5xl mx-auto relative">
          <div className="text-center mb-14">
            <Reveal>
              <span className="text-brand text-xs font-semibold tracking-widest uppercase">Perjalanan Kami</span>
      ...
      <section id="layanan" className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <Reveal>
              <span className="text-brand text-xs font-semibold tracking-widest uppercase">Layanan Kami</span>
              ...
              <Reveal key={service.title} delay={idx * 100} direction="up" distance={20}>
                <div className="glass-card rounded-2xl overflow-hidden group transform transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl flex flex-col">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <h3 className="text-white font-bold text-base group-hover:text-brand transition-colors">{service.title}</h3>
      ...
      {/* ─── MEMBERSHIP ─── */}
      <section id="membership" className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-900 relative overflow-hidden">
      ...
      {/* ─── GALERI ─── */}
      <section id="galeri" className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <Reveal>
      ...
      <section className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-950 relative overflow-hidden">
            ...
            {[
              ...
              <Reveal key={item.title} delay={idx * 100} direction="up" distance={20}>
                <div className="glass-card rounded-2xl p-6 text-center group transform transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl">
                  <div className="w-14 h-14 rounded-xl mx-auto mb-4 flex items-center justify-center text-brand bg-blue-500/10 group-hover:bg-blue-500/20 transition-all group-hover:scale-110 group-hover:rotate-6">
                    <RotatingIcon duration={12}>
                      {item.icon}
                    </RotatingIcon>
                  </div>
                  <h3 className="text-white font-bold text-base mb-1 group-hover:text-brand transition-colors">{item.title}</h3>
      ...
      <section className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <Reveal direction="left" distance={30}>
              <div className="rounded-2xl overflow-hidden shadow-2xl glow-brand group">
                <img
                  src={IMAGES.mechanic}
      ...
      {/* ─── ALUR SERVIS ─── */}
      <section className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-950">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <Reveal>
              <span className="text-brand text-xs font-semibold tracking-widest uppercase">Proses Servis</span>
              ...
              <Reveal key={step.label} delay={idx * 100} direction="up" distance={20}>
                <div className="flex items-center gap-3 flow-connector">
                  <div className="glass-card rounded-2xl p-5 text-center w-40 transform transition-all duration-500 hover:scale-110 hover:shadow-2xl">
                    ...
                    <div className="text-white font-bold text-sm group-hover:text-brand transition-colors">{step.label}</div>
                  </div>
                </div>
              </Reveal>
            ))}
      ...
      {/* ─── PROMO + COUNTDOWN ─── */}
      <section className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-900 relative">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Reveal delay={150} direction="right" distance={20}>
              <div className="glass-card rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-5 border-orange-500/20 transform transition-all duration-500 hover:scale-105 hover:shadow-2xl">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span className="text-brand text-xs font-bold uppercase tracking-wider">Flash Sale</span>
          ...
          {loadingData ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((review, idx) => (
                <Reveal key={review.id} delay={idx * 150} direction="up" distance={30}>
                  <div className="glass-card rounded-2xl p-8 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl h-full flex flex-col">
                    <div className="flex gap-1 mb-4">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} className={`w-5 h-5 ${i < review.rating ? 'text-yellow-400' : 'text-yellow-400/40'}`} fill="currentColor" viewBox="0 0 20 20">
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                      ))}
                    </div>
                    <p className="text-gray-300 text-sm leading-relaxed italic mb-6 flex-1">
                      {review.text}
                    </p>
                    <div className="flex items-center gap-4 mt-auto border-t border-white/5 pt-4">
                      <img src={getAvatar(review.avatarId)} alt="Customer" className="w-10 h-10 rounded-full border-2 border-blue-500/40 object-cover" />
                      <div>
                        <p className="text-white font-semibold text-sm">{review.name}</p>
                        <p className="text-gray-500 text-xs">{review.vehicle} · {review.tier}</p>
                      </div>
                    </div>
                  </div>
                </Reveal>
      ...
      {/* ─── TIM MEKANIK ─── */}
      <section id="tim" className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <Reveal>
              <span className="text-brand text-xs font-semibold tracking-widest uppercase">Tim Ahli</span>
            ...
            {[
              ...
              <Reveal key={m.name} delay={idx * 100} direction="up" distance={20}>
                <div className="glass-card rounded-2xl overflow-hidden text-center transform transition-all duration-500 hover:-translate-y-4 hover:shadow-2xl">
                  ...
                  <div className="p-5">
                    <h4 className="text-white font-bold group-hover:text-brand transition-colors">{m.name}</h4>
                    <p className="text-brand text-xs font-medium">{m.role}</p>
                  </div>
                </div>
              </Reveal>
            ))}
      ...
      {/* ─── FAQ ─── */}
      <section id="faq" className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-950">
      ...
      {/* ─── LOKASI & MAPS ─── */}
      <section id="lokasi" className="py-24 px-6 sm:px-10 lg:px-16 bg-garage-900 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <Reveal>
              <span className="text-brand text-xs font-semibold tracking-widest uppercase">Kunjungi Kami</span>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            <Reveal direction="left" distance={30}>
              <div className="rounded-2xl overflow-hidden shadow-xl glow-brand h-full transform transition-all duration-500 hover:scale-[1.02]">
                <img
                  src={IMAGES.location}
                ...
                <div className="glass-dark p-5">
                  <div className="flex items-center gap-2.5 mb-2">
                    <MdGpsFixed className="w-5 h-5 text-brand animate-pulse" />
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 mt-3 text-brand hover:text-blue-300 text-xs font-medium transition-all hover:gap-3"
                  >
                    Buka di Google Maps
            ...
            <Reveal delay={100} direction="up" distance={30}>
              <div className="glass-card rounded-2xl p-6 h-full transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
                ...
                <div className="mt-5 pt-4 border-t border-white/10 flex items-start gap-2.5">
                  <MdSupportAgent className="w-4 h-4 text-brand shrink-0 mt-0.5 animate-float" />
      ...
      <section id="kontak" className="py-24 px-6 sm:px-10 lg:px-16 bg-[#0B1120] relative">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="text-center mb-14">
            <Reveal>
              <span className="text-brand text-xs font-semibold tracking-widest uppercase">Hubungi Kami</span>
      ...
      <section className="relative py-28 px-6 sm:px-10 lg:px-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <Reveal direction="up" distance={30}>
            <div className="inline-flex items-center gap-2.5 mb-5 px-4 py-1.5 rounded-full border-brand bg-blue-500/10 backdrop-blur-sm animate-pulse-slow">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3.5 animate-fade-in-up animation-delay-500">
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 gradient-bg-brand text-white font-bold px-8 py-4 rounded-2xl transition-all duration-300 shadow-lg glow-brand hover:glow-brand hover:scale-[1.02] active:scale-95 text-sm group"
              >
                🚗 Booking Sekarang
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2.5 glass-dark hover:bg-white/10 text-white font-semibold px-8 py-4 rounded-2xl transition-all duration-300 text-sm border border-white/10 hover:border-brand hover:scale-[1.02] group"
              >
      ...
      <footer className="py-10 px-6 sm:px-10 lg:px-16 bg-[#080D18] border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-500">
            <a href="#" className="hover:text-brand transition hover:scale-110">Privacy</a>
            <a href="#" className="hover:text-brand transition hover:scale-110">Terms</a>
            <a href="#" className="hover:text-brand transition hover:scale-110">Contact</a>
          </div>
        </div>
      </footer>
